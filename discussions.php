	...
	<td class="post-list-row-container">
		...
		<div class="clearfix">
            ...
            <div class="post-list-group-badge">
                <?php if($user->GetUserGroup($posterrow[0]) != false){ ?><a href="<?php echo groupURL($user->GetUserGroup($posterrow[0])); ?>"><img src="<?php echo BADGE; ?>/habbo-imaging/badge/<?php echo $user->GetUserGroupBadge($posterrow[0]); ?>.gif" /></a><?php } ?>
            </div>
