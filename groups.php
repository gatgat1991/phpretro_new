...
include_once ('./templates/community_header.php');
...
<?php if($page['edit'] != true){ ?>
	<?php if($memberrow[2]=="0" && $page['edit'] != true){ ?><a href="#" id="myhabbo-group-tools-button" class="new-button dark-button edit-icon" style="float:left"><b><span></span><?php echo $lang->loc['edit']; ?></b><i></i></a><?php } ?>
	<div class="myhabbo-view-tools">
				...
				<?php } ?>
				<?php if($memberrow[0] == ""){ ?>
					<?php if(($grouprow[7] == 0 || $grouprow[7] == 1 || $grouprow[7] == 2) && $user->id != 0){ ?><a href="<?php echo PATH; ?>/groups/actions/join?groupId=<?php echo $grouprow[0]; ?>" id="join-group-button"><?php if($grouprow[7] == 0){ echo $lang->loc['join']; }else{ echo $lang->loc['request.membership']; } ?></a><?php } ?>
				...
				<?php }elseif($memberrow[2] <= 2  && $memberrow[4] != 1){ ?>
...
<?php } ?>
    <h2 class="page-owner">
    	<?php echo $input->HoloText($grouprow[2]); ?>
			<?php if($grouprow[7] == 1){ ?><img src="<?php echo PATH; ?>/web-gallery/images/groups/status_exclusive_big.gif" width="18" height="16" alt="<?php echo $lang->loc['exclusive.group']; ?>" title="<?php echo $lang->loc['exclusive.group']; ?>" class="header-bar-group-status" /><?php } ?>
			<?php if($grouprow[7] == 2){ ?><img src="<?php echo PATH; ?>/web-gallery/images/groups/status_closed_big.gif" width="18" height="16" alt="<?php echo $lang->loc['closed.group']; ?>" title="<?php echo $lang->loc['closed.group']; ?>" class="header-bar-group-status" /><?php } ?>
    </h2>
    <ul class="box-tabs">
