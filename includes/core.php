...
$serverdb = new $conn['server']['server']($conn['server']);
...
//require('./includes/'.$settings->find("hotel_server").'.php');
...
define( 'PATH', siteURL() );
//BadgeURL PHP 7
define("BADGE", 'http://swf.habb0.ml/');
