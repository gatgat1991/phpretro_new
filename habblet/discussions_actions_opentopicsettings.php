...
<form action="#" method="post" id="topic-settings-form">
	...
	<div id="topic-type-area">
	    ...
	    <div class="topic-type-input">
	    	<input type="radio" name="topic_type" id="topic_open" value="0"<?php if($topicrow['open'] == 1){ ?> checked="true"<?php } if($memberrow[2] > 2){ ?> disabled="true"<?php } ?> /> <?php echo $lang->loc['open']; ?><br /><input type="radio" name="topic_sticky" id="topic_normal" value="0" <?php if($topicrow['sticky'] == 0){ ?> checked="true"<?php } if($memberrow[2] > 2){ ?> disabled="true"<?php } ?>/> <?php echo $lang->loc['normal']; ?>
	    </div>
	    <div class="topic-type-input">
	    	 <input type="radio" name="topic_type" id="topic_closed" value="1"<?php if($topicrow['open'] == '0'){ ?> checked="true"<?php } if($memberrow[2] == '0'){ ?> disabled="true"<?php } ?>  /> <?php echo $lang->loc['closed'] ?><br /><input type="radio" name="topic_sticky" id="topic_sticky" value="1"<?php if($topicrow['sticky'] == 3){ ?> checked="true"<?php } if($memberrow[2] > 2){ ?> disabled="true"<?php } ?>
	...
	<div id="topic-button-area" class="topic-button-area">
		...
		<?php if($memberrow[2] == '0'){ ?><a href="#" class="new-button delete-topic" id="delete-topic"><b><?php echo $lang->loc['delete']; ?></b><i></i></a><?php } ?>
