...
<div class="header_left">&nbsp;<br />&nbsp;<br />&nbsp;<br /><a href="<?php echo PATH; ?>"><img src="<?php echo PATH; ?>/housekeeping/images/header_logo.png" alt="PHPRetro"></a></div>
<div class="header_right"><img src="<?php echo PATH; ?>/housekeeping/images/header_tm1.gif"></div>

<div class="panel_title">
<span class="text">PHPRetro </span>
