...
if (isset($_GET['category'])) { $category = $input->stringToURL($input->HoloText($_GET['category'],true),true,false);} 
if (isset($_GET['archive'])) { $archive = $_GET['archive'];} 
if (isset($_GET['pageNumber'])) { $pagenum = $input->FilterText($_GET['pageNumber']);} 
